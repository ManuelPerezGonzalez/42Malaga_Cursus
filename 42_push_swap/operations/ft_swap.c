...
/*   Updated: 2022/09/20 10:23:24 by maperez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_swap_a(st_stacks *stack, int checkwrite)
{
    int temp;
...
void    ft_swap_b(st_stacks *stack, int checkwrite)
{
    int temp;
...
void    ft_swap_both(st_stacks *stacks, int checkwrite)
{
    ft_swap_a(stacks, 0);
    ft_swap_b(stacks, 0);
    if (checkwrite)
